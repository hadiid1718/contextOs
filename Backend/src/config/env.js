...
export const env = {
  ...
  googleClientSecret: process.env.GOOGLE_CLIENT_SECRET || "disabled-google-client-secret",
  googleCallbackUrl:
    process.env.GOOGLE_CALLBACK_URL || "http://localhost:4001/api/v1/auth/oauth/google/callback",
  githubClientId: process.env.GITHUB_CLIENT_ID || "disabled-github-client-id",
  githubClientSecret: process.env.GITHUB_CLIENT_SECRET || "disabled-github-client-secret",
  githubCallbackUrl:
    process.env.GITHUB_CALLBACK_URL || "http://localhost:4001/api/v1/auth/oauth/github/callback",
